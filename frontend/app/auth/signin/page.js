...
function AuthBackground() {
  ...
  return (
    <div className="fixed inset-0 bg-[#020617] overflow-hidden -z-10">
      ...
      <div
        className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-500/10 rounded-full blur-[120px] animate-pulse"
...
function SignInContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // (optional if you have refresh token)
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 text-sm sm:text-base font-medium">
            Log in to manage your financial portfolio.
          </p>
        </div>
          ...
          <div className="relative bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 sm:p-10 shadow-2xl overflow-hidden">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label className="text-[11px] font-black text-white uppercase tracking-widest">
                    Password
                  </label>
                  <Link
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <p className="text-slate-400 text-sm font-medium">
                ...
                <Link
                  href="/auth/signup"
                  className="text-indigo-400 hover:text-indigo-300 transition-colors ml-2 font-bold underline underline-offset-4 decoration-indigo-400/20 hover:decoration-indigo-400"
                >
                  Create Account
                </Link>
              </p>
        ...
        <div className="mt-8 flex justify-center gap-6 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500">
          <p className="text-[11px] text-white uppercase tracking-[4px] font-black">
            Encrypted • Private • Fast
          </p>
        </div>
      </motion.div>
    </div>
